 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'A','b','s','o','l','u','t','e','M','o','u','s','e'
 ...
 */
#define USB_CFG_INTERFACE_CLASS     3  /* HID */ /* define class here if not at device level */
 ...
 */
#define USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH 126
